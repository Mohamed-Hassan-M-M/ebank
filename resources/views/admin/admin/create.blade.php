                ...
                <div class="row">
                    <div class="col-md-6 m-auto">
                        ...
                        <div class="card card-success">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form" action="{{route('admin.admin.doCreate')}}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('username') is-invalid @enderror " value="" id="username" placeholder="Enter username" name="username">
                                        @error('username')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
