        ...
        <div class="row">
            <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
                <figure class="circle-bg">
                    <img src="{{asset('assets/front/images/img_2.jpg')}}" alt="Free Website Template by Free-Template.co" class="img-fluid">
                </figure>
            </div>
    ...
    <div class="container">
        <div class="row mb-5">
            ...
            <div class="col-md-4 text-center" data-aos="fade-up" data-aos-delay="100">
                <img src="{{asset('assets/front/images/flaticon-svg/svg/004-cart.svg')}}" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
                <figure class="circle-bg">
                    <img src="{{asset('assets/front/images/about_2.jpg')}}" alt="Free Website Template by Free-Template.co" class="img-fluid">
                </figure>
            </div>
            <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                <div class="mb-4">
    ...
    <div class="container">
        ...
        <div class="row align-items-stretch">
            ...
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="unit-4">
                    <div class="unit-4-icon">
                        <img src="{{asset('assets/front/images/flaticon-svg/svg/002-rich.svg')}}" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
                    </div>
                    <div>
            ...
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="unit-4">
                    <div class="unit-4-icon">
                        <img src="{{asset('assets/front/images/flaticon-svg/svg/005-megaphone.svg')}}" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
                    </div>
                    <div>
    ...
    <div class="slide-one-item home-slider owl-carousel">
        <div>
            <div class="testimonial">
                ...
                <figure class="mb-4 d-flex align-items-center justify-content-center">
                    <div><img src="{{asset('assets/front/images/person_1.jpg')}}" alt="Image" class="w-50 img-fluid mb-3"></div>
                    <p>John Smith</p>
                </figure>
            </div>
        </div>
        <div>
            <div class="testimonial">
                ...
                <figure class="mb-4 d-flex align-items-center justify-content-center">
                    <div><img src="{{asset('assets/front/images/person_2.jpg')}}" alt="Image" class="w-50 img-fluid mb-3"></div>
        ...
        <div>
            <div class="testimonial">
                ...
                <figure class="mb-4 d-flex align-items-center justify-content-center">
                    <div><img src="{{asset('assets/front/images/person_3.jpg')}}" alt="Image" class="w-50 img-fluid mb-3"></div>
                    <p>Robert Spears</p>
                </figure>
