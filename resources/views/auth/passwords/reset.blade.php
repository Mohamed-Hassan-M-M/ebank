            ...
            <div class="card-body">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" class="form-control disabled" @error('email') is-invalid @enderror" name="email" value="{{ old('email',\Illuminate\Support\Facades\Request::input('email')) }}" required autocomplete="email">
